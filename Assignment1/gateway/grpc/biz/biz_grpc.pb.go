...
type BizClient interface {
	...
	GetUsersWithSQLInject(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *bizClient) GetUsers(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
	err := c.cc.Invoke(ctx, "/authz_server.Biz/GetUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bizClient) GetUsersWithSQLInject(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
	err := c.cc.Invoke(ctx, "/authz_server.Biz/GetUsersWithSQLInject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BizServer interface {
	...
	GetUsersWithSQLInject(context.Context, *GetUserRequest) (*GetUserResponse, error)
...
func (UnimplementedBizServer) GetUsers(context.Context, *GetUserRequest) (*GetUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedBizServer) GetUsersWithSQLInject(context.Context, *GetUserRequest) (*GetUserResponse, error) {
...
func _Biz_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authz_server.Biz/GetUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BizServer).GetUsers(ctx, req.(*GetUserRequest))
	}
...
func _Biz_GetUsersWithSQLInject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authz_server.Biz/GetUsersWithSQLInject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BizServer).GetUsersWithSQLInject(ctx, req.(*GetUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
